...
public class AuthenticationFilter implements Filter
{
	    ...
	    //    System.out.println(token);
	       ...
	       /*  actual code-> not working admin logout if (requestURI.startsWith("/api/") && role != Role.CUSTOMER) {
	            sendErrorResponse(httpResponse, HttpServletResponse.SC_FORBIDDEN,
	    ...
	    // Allow logout for all roles includeing admin logout
	       ...
	       // Customer-only endpoints (adjust the paths as needed)
